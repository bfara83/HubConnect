...
[
	...
	"ringcamera":		[driver: "Ring Floodlight Camera", selector: "ringfloodlight", capability: "motion", prefGroup: "other", attr: ["switch", "motion"]],
        "ringdoorbell":		[driver: "Ring Doorbell", selector: "ringDoorbellPros", capability: "motion", prefGroup: "other", attr: ["numberOfButtons", "pushed", "motion"]],
	...
	"temphumidity":         [driver: "Temperature Humidity Sensor", selector: "temphumidity", capability: "temperature", prefGroup: "sensors", attr: ["battery", "temperature", "humidity"]],
